...
**影视资源自动化——资源站搜片/提取磁力→网盘离线缓存→在线观看。触发：电影资源、磁力链接、115离线。**

[SkillHub 在线安装](https://skillhub.cn/skills/media-resource-automation) · [快速使用](#快速使用) · [核心能力](#核心能力) · [使用边界](#使用边界)
...
```text
使用 media-resource-automation 技能。
这是待处理内容，直接执行。
```
...
- 涉及「media-resource-automation」的场景任务
- 需要复用已验证方法论的工作
- 批量/复杂任务中的专项环节
